      ...
      <div className="bg-white mt-4 shadow-md p-6 ml-5 rounded-lg">
        <div className="grid grid-cols-5 gap-10">
          ...
          <div className="flex flex-col items-center">
            <div className="grid grid-cols-2 gap-4 pb-4 border-b-1 border-l-1 w-full">
              <MdQuestionAnswer className="place-self-end" />
              <p className=" text-start">{answers}</p>
            </div>
